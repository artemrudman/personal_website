...
async function loadHeader() {
  ...
  try {
    ...
    const headerPath = isArticlePage
    ...
    if (!response.ok) {
      console.error(
        `Failed to fetch header: ${response.status} ${response.statusText}`
      );
...
function setActiveNavigation() {
  ...
  if (currentPath.endsWith("index.html") || currentPath.endsWith("/")) {
  ...
  } else if (currentPath.endsWith("skills.html")) {
    document.querySelector('a[href="skills.html"]')?.classList.add("active");
  } else if (currentPath.endsWith("work.html")) {
    document.querySelector('a[href="work.html"]')?.classList.add("active");
    ...
    // We're on an article page
    document.querySelector('a[href="blog.html"]')?.classList.add("active");
  }
}
            ...
            <div class="container">
                <nav role="navigation" aria-label="Main navigation">
                    ...
                    <div class="nav-links" role="menubar">
                        <a href="${
                          isArticlePage ? "../about.html" : "about.html"
                        }" class="nav-link" role="menuitem">About</a>
                        <a href="${
                          isArticlePage ? "../writings.html" : "writings.html"
                        }" class="nav-link" role="menuitem">Writings</a>
                        <a href="${
                          isArticlePage ? "../bookmarks.html" : "bookmarks.html"
                        }" class="nav-link" role="menuitem">Bookmarks</a>
